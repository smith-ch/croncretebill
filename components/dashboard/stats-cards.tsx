    ...
    <div className="grid gap-3 grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
      ...
      <Card className={`border-0 shadow-lg bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] relative overflow-hidden group`}>
        ...
        <div className={`hidden lg:block absolute top-0 right-0 w-24 h-24 rounded-full -translate-y-12 translate-x-12 group-hover:scale-110 transition-transform duration-300 ${
          netProfit >= 0 ? 'bg-gradient-to-br from-emerald-600/20 to-green-600/30' : 'bg-gradient-to-br from-red-600/20 to-pink-600/30'
        }`}></div>
        <CardHeader className="flex flex-row items-center justify-between pb-2 relative p-3 lg:p-6">
          <div className="flex-1 min-w-0">
      ...
      {/* Clients - Enhanced */}
      <Card className="border-0 shadow-2xl bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 hover:shadow-3xl transition-all duration-500 hover:scale-105 relative overflow-hidden group">
        ...
        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-indigo-600/20 to-purple-600/30 rounded-full -translate-y-12 translate-x-12 group-hover:scale-110 transition-transform duration-500"></div>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative">
          <div className="space-y-1">
            <CardTitle className="text-sm font-bold text-indigo-400 uppercase tracking-wide">Clientes</CardTitle>
        ...
        <CardContent className="relative">
          <div className="text-3xl font-bold text-indigo-300 mb-2">{totalClients}</div>
      ...
      <Card className="border-0 shadow-2xl bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 hover:shadow-3xl transition-all duration-500 hover:scale-105 relative overflow-hidden group">
        ...
        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-cyan-600/20 to-teal-600/30 rounded-full -translate-y-12 translate-x-12 group-hover:scale-110 transition-transform duration-500"></div>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative">
          <div className="space-y-1">
            <CardTitle className="text-sm font-bold text-cyan-400 uppercase tracking-wide">Productos</CardTitle>
            <div className="flex items-center gap-2">
        ...
        <CardContent className="relative">
          <div className="text-3xl font-bold text-cyan-300 mb-2">{totalProducts}</div>
          <div className="flex items-center justify-between text-sm">
      ...
      <Card className="border-0 shadow-2xl bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 hover:shadow-3xl transition-all duration-500 hover:scale-105 relative overflow-hidden group">
        ...
        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-violet-600/20 to-purple-600/30 rounded-full -translate-y-12 translate-x-12 group-hover:scale-110 transition-transform duration-500"></div>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative">
          <div className="space-y-1">
            <CardTitle className="text-sm font-bold text-violet-400 uppercase tracking-wide">Proyectos</CardTitle>
            <div className="flex items-center gap-2">
        ...
        <CardContent className="relative">
          <div className="text-3xl font-bold text-violet-300 mb-2">{totalProjects}</div>
          <div className="flex items-center justify-between text-sm">
      ...
      <Card className="border-0 shadow-2xl bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 hover:shadow-3xl transition-all duration-500 hover:scale-105 relative overflow-hidden group">
        ...
        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-amber-600/20 to-orange-600/30 rounded-full -translate-y-12 translate-x-12 group-hover:scale-110 transition-transform duration-500"></div>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative">
          <div className="space-y-1">
            <CardTitle className="text-sm font-bold text-amber-400 uppercase tracking-wide">Este Mes</CardTitle>
            <div className="flex items-center gap-2">
        ...
        <CardContent className="relative">
          <div className="text-3xl font-bold text-amber-400 mb-2">{monthlyInvoices}</div>
          <div className="flex items-center justify-between text-sm">
