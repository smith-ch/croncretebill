      ...
      {permissions.canViewFinances && (
        ...
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative">
          <div className="space-y-1">
            <CardTitle className="text-sm font-bold text-blue-700 uppercase tracking-wide">Ingresos Totales</CardTitle>
        ...
        <CardContent className="relative">
          <div className="text-3xl font-bold text-blue-900 mb-2">{formatCurrency(totalRevenue)}</div>
          <div className="flex items-center justify-between text-sm">
            <span className="text-blue-600 font-medium">Esta semana:</span>
