          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600 mt-1">Sistema de Facturación y Gestión Empresarial</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <CardContent className="space-y-6">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              <div className="flex-1 space-y-4">
                ...
                <p className="text-slate-600">
                  Especialista en desarrollo de aplicaciones web modernas con más de 5 años de experiencia 
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 text-slate-600">
                  ...
                  <span className="text-sm">5+ años de experiencia</span>
                </div>
                <div className="flex items-center gap-2 text-slate-600">
                  <CheckCircle className="w-4 h-4 text-green-500" />
                  <span className="text-sm">50+ proyectos completados</span>
                </div>
              </div>
            </div>
            ...
            <div className="border-t pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center gap-3 text-slate-600">
                  ...
                  <span className="text-sm">smith.rodriguez.dev@gmail.com</span>
                </div>
                <div className="flex items-center gap-3 text-slate-600">
