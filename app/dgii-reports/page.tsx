          ...
          <CardContent className="p-3 sm:p-4 lg:p-6">
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-300 truncate">
          ...
          <CardContent className="p-3 sm:p-4 lg:p-6">
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl font-bold text-orange-300 truncate">
          ...
          <CardContent className="p-3 sm:p-4 lg:p-6">
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl font-bold text-purple-300 truncate">
