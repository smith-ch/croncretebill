                ...
                <CardContent className="p-3 lg:p-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-base lg:text-lg font-bold text-blue-300 truncate">{formatCurrency(kpiData.totalRevenue)}</p>
                ...
                <CardContent className="p-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-lg font-bold text-emerald-300">{formatCurrency(kpiData.netProfit)}</p>
                ...
                <CardContent className="p-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-lg font-bold text-red-300">{formatCurrency(kpiData.totalExpenseAmount)}</p>
                      <div className="flex items-center space-x-1">
                ...
                <CardContent className="p-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-lg font-bold text-purple-300">{kpiData.businessHealthScore}/100</p>
                ...
                <CardContent className="p-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-lg font-bold text-amber-300">{kpiData.averageGrowth >= 0 ? '+' : ''}{kpiData.averageGrowth}%</p>
                ...
                <CardContent className="p-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-lg font-bold text-orange-300">{kpiData.totalExpenses}</p>
                ...
                <CardContent className="p-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-lg font-bold text-pink-300">{formatCurrency(kpiData.avgExpenseValue)}</p>
                ...
                <CardContent className="p-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-lg font-bold text-indigo-300">{kpiData.consistencyScore.toFixed(0)}%</p>
                    ...
                    <div key={index} className="p-4 bg-gradient-to-r from-slate-50 to-slate-100 rounded-lg border border-slate-800 hover:shadow-md transition-shadow">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 lg:gap-4 text-sm">
                        <div className="text-center p-2 bg-slate-900 rounded border border-slate-700">
                          ...
                          <p className="font-bold text-blue-300">{formatCurrency(month.totalRevenue)}</p>
                          {index > 0 && (
                        ...
                        <div className="text-center p-2 bg-red-900/30 rounded border border-red-800">
                          ...
                          <p className="font-bold text-red-300">{formatCurrency(month.expenseAmount)}</p>
                        ...
                        <div className="text-center p-2 bg-emerald-900/30 rounded border border-emerald-800">
                          ...
                          <p className="font-bold text-emerald-300">{month.roi.toFixed(1)}%</p>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-emerald-900/30 rounded-lg border border-emerald-800">
                      <div>
                        ...
                        <p className="text-lg font-bold text-emerald-300">{kpiData.bestMonth}</p>
                    ...
                    <div className="flex justify-between items-center p-3 bg-red-900/30 rounded-lg border border-red-800">
                      <div>
                        ...
                        <p className="text-lg font-bold text-red-300">{kpiData.worstMonth}</p>
